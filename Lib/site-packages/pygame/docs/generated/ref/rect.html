...
<html lang="en">
  <head>
    ...
    <title>pygame.Rect &#8212; pygame-ce v2.3.1 documentation</title>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.2: </span>Since version 2.2 there is another class called FRect that serves the same purpose as as <cite>Rect</cite> but it can hold floats instead of integers.</p>
</div>
