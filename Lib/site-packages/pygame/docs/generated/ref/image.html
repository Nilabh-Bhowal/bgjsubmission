...
<html lang="en">
  <head>
    ...
    <title>pygame.image &#8212; pygame-ce v2.3.1 documentation</title>
...
<div class="line"><span class="signature">load(file) -&gt; Surface</span></div>
...
<div class="line"><span class="signature">save(Surface, file) -&gt; None</span></div>
...
<p>DEPRECATED: This function has the same functionality as <a class="reference internal" href="#pygame.image.tobytes" title="pygame.image.tobytes"><code class="xref py py-func docutils literal notranslate"><span class="pre">tobytes()</span></code></a>, which is preferred and should be used.</p>
...
<p>DEPRECATED: This function has the same functionality as <a class="reference internal" href="#pygame.image.frombytes" title="pygame.image.frombytes"><code class="xref py py-func docutils literal notranslate"><span class="pre">frombytes()</span></code></a>, which is preferred and should be used.</p>
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since pygame-ce 2.3.0.</span></p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">load_extended(file) -&gt; Surface</span></div>
...
<div class="line"><span class="signature">save_extended(Surface, file) -&gt; None</span></div>
