...
<html lang="en">
  <head>
    ...
    <title>pygame.mixer &#8212; pygame-ce v2.3.1 documentation</title>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.set_soundfont">pygame.mixer.set_soundfont</a></div>
</td>
<td>—</td>
<td>set the soundfont for playing midi music</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.get_soundfont">pygame.mixer.get_soundfont</a></div>
</td>
<td>—</td>
...
<span class="sig-prename descclassname"><span class="pre">pygame.mixer.</span></span><span class="sig-name descname"><span class="pre">set_soundfont</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.set_soundfont" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
...
<span class="sig-prename descclassname"><span class="pre">pygame.mixer.</span></span><span class="sig-name descname"><span class="pre">get_soundfont</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.get_soundfont" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.set_source_location">pygame.mixer.Channel.set_source_location</a></div>
</td>
<td>—</td>
<td>set the position of a playing channel</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.set_volume">pygame.mixer.Channel.set_volume</a></div>
</td>
<td>—</td>
<td>set the volume of a playing channel</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.get_volume">pygame.mixer.Channel.get_volume</a></div>
</td>
<td>—</td>
<td>get the volume of the playing channel</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.get_busy">pygame.mixer.Channel.get_busy</a></div>
</td>
<td>—</td>
<td>check if the channel is active</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.get_sound">pygame.mixer.Channel.get_sound</a></div>
</td>
<td>—</td>
<td>get the currently playing Sound</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.queue">pygame.mixer.Channel.queue</a></div>
</td>
<td>—</td>
<td>queue a Sound object to follow the current</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.get_queue">pygame.mixer.Channel.get_queue</a></div>
</td>
<td>—</td>
<td>return any Sound that is queued</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.set_endevent">pygame.mixer.Channel.set_endevent</a></div>
</td>
<td>—</td>
<td>have the channel send an event when playback stops</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="mixer.html#pygame.mixer.Channel.get_endevent">pygame.mixer.Channel.get_endevent</a></div>
</td>
<td>—</td>
...
<span class="sig-name descname"><span class="pre">set_source_location</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.Channel.set_source_location" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
...
<p><cite>angle</cite>: Angle is in degrees.</p>
