...
<html lang="en">
  <head>
    ...
    <title>pygame.draw &#8212; pygame-ce v2.3.1 documentation</title>
...
<blockquote>
<div><ul class="simple">
<li><p>a <a class="tooltip reference internal" href="color.html#pygame.Color" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.Color</span></code><span class="tooltip-content">pygame object for color representations</span></a> object, or a type (apart from <code class="docutils literal notranslate"><span class="pre">int</span></code>) that can be passed to
its constructor</p></li>
<li><p>an <code class="docutils literal notranslate"><span class="pre">int</span></code> value which must be mapped to the pixel format of the surface
...
<li><p><strong>color</strong> (Color or string (for <a class="reference internal" href="color_list.html"><span class="doc">Named Colors</span></a>) or int or tuple(int, int, int, [int])) -- color to draw with, the alpha value is optional if using a
