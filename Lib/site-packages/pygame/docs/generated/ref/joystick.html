...
<html lang="en">
  <head>
    ...
    <title>pygame.joystick &#8212; pygame-ce v2.3.1 documentation</title>
...
<span class="k">def</span> <span class="nf">indent</span><span class="p">(</span><span class="n">text</span><span class="p">,</span> <span class="n">indentation_level</span><span class="o">=</span><span class="mi">0</span><span class="p">):</span>
...
<span class="k">def</span> <span class="nf">main</span><span class="p">():</span>
    ...
    <span class="k">while</span> <span class="ow">not</span> <span class="n">done</span><span class="p">:</span>
        ...
        <span class="n">lines</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">indent</span><span class="p">(</span><span class="s2">&quot;Number of joysticks: </span><span class="si">{joystick_count}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">indentation</span><span class="p">))</span>
...
<section id="nintendo-switch-left-right-joy-con-pygame-2-3-0-after-sdl-2-24-0">
<h2>Nintendo Switch Left/Right Joy-Con (pygame <strong>2.3.0</strong> / after SDL <strong>2.24.0</strong>)<a class="headerlink" href="#nintendo-switch-left-right-joy-con-pygame-2-3-0-after-sdl-2-24-0" title="Permalink to this heading">¶</a></h2>
