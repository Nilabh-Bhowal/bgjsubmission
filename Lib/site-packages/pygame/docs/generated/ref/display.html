...
<html lang="en">
  <head>
    ...
    <title>pygame.display &#8212; pygame-ce v2.3.1 documentation</title>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.is_vsync">pygame.display.is_vsync</a></div>
</td>
<td>—</td>
<td>Returns True if vertical synchronisation for pygame.display.flip() is enabled</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.get_current_refresh_rate">pygame.display.get_current_refresh_rate</a></div>
</td>
<td>—</td>
<td>Returns the screen refresh rate or 0 if unknown</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="display.html#pygame.display.get_desktop_refresh_rates">pygame.display.get_desktop_refresh_rates</a></div>
</td>
<td>—</td>
...
<p><span class="versionmodified added">New in pygame-ce 2.0.0: </span><code class="docutils literal notranslate"><span class="pre">SCALED</span></code>, <code class="docutils literal notranslate"><span class="pre">SHOWN</span></code> and <code class="docutils literal notranslate"><span class="pre">HIDDEN</span></code></p>
</div>
...
<a class="tooltip reference internal" href="#pygame.display.flip" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.flip()</span></code><span class="tooltip-content">Update the full display Surface to the screen</span></a> will block (i.e. <em>wait</em>) until the screen has
refreshed.
Be careful when using this feature together with <code class="docutils literal notranslate"><span class="pre">pygame.time.Clock</span></code> or
...
will request the OpenGL-specific feature &quot;adaptive vsync&quot;.</p>
...
<span class="n">current_h</span><span class="p">,</span> <span class="n">current_w</span><span class="p">:</span>  <span class="n">Height</span> <span class="ow">and</span> <span class="n">width</span> <span class="n">of</span> <span class="n">the</span> <span class="n">current</span> <span class="n">video</span> <span class="n">mode</span><span class="p">,</span> <span class="ow">or</span>
            ...
            <span class="ow">is</span> <span class="n">called</span><span class="o">.</span> <span class="n">They</span> <span class="n">are</span> <span class="o">-</span><span class="mi">1</span> <span class="n">on</span> <span class="n">error</span><span class="o">.</span>
</pre></div>
</div>
</dd></dl>
...
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">is_vsync</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.display.is_vsync" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns True if vertical synchronisation for pygame.display.flip() is enabled</span></div>
...
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">get_current_refresh_rate</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">int</span></span></span><a class="headerlink" href="#pygame.display.get_current_refresh_rate" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
...
<span class="sig-prename descclassname"><span class="pre">pygame.display.</span></span><span class="sig-name descname"><span class="pre">get_desktop_refresh_rates</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">list</span></span></span><a class="headerlink" href="#pygame.display.get_desktop_refresh_rates" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Returns the screen refresh rates for all displays (in windowed mode).</span></div>
<div class="line"><span class="signature">get_desktop_refresh_rates() -&gt; list</span></div>
</div>
