...
<html lang="en">
  <head>
    ...
    <title>pygame.event &#8212; pygame-ce v2.3.1 documentation</title>
...
<a class="tooltip reference internal" href="#pygame.event.set_blocked" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.set_blocked()</span></code><span class="tooltip-content">control which events are blocked on the queue</span></a> to limit which events get queued.</p>
...
<a class="tooltip reference internal" href="#pygame.event.set_allowed" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.set_allowed()</span></code><span class="tooltip-content">control which events are allowed on the queue</span></a> and <a class="tooltip reference internal" href="#pygame.event.set_blocked" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.event.set_blocked()</span></code><span class="tooltip-content">control which events are blocked on the queue</span></a> to
...
<p><span class="versionmodified added">New in pygame-ce 2.1.3: </span>Added <code class="docutils literal notranslate"><span class="pre">precise_x</span></code> and <code class="docutils literal notranslate"><span class="pre">precise_y</span></code> to <code class="docutils literal notranslate"><span class="pre">MOUSEWHEEL</span></code> events</p>
</div>
<div class="line-block">
<div class="line"><br /></div>
</div>
...
<span class="n">DROPBEGIN</span>
<span class="n">DROPCOMPLETE</span>
<span class="n">DROPTEXT</span>
...
<span class="n">KEYMAPCHANGED</span>
...
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.3: </span><code class="docutils literal notranslate"><span class="pre">KEYMAPCHANGED</span></code>, <code class="docutils literal notranslate"><span class="pre">CLIPBOARDUPDATE</span></code>,
...
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.3: </span><code class="docutils literal notranslate"><span class="pre">WINDOWICCPROFCHANGED</span></code> and <code class="docutils literal notranslate"><span class="pre">WINDOWDISPLAYCHANGED</span></code></p>
</div>
<div class="line-block">
<div class="line"><br /></div>
</div>
