...
<html lang="en">
  <head>
    ...
    <title>pygame.Surface &#8212; pygame-ce v2.3.1 documentation</title>
...
<p>The color argument can be an <code class="docutils literal notranslate"><span class="pre">RGB</span></code> sequence, an <code class="docutils literal notranslate"><span class="pre">RGBA</span></code> sequence,
a string (for <a class="reference internal" href="color_list.html"><span class="doc">Named Colors</span></a>), or a mapped color index. If using <code class="docutils literal notranslate"><span class="pre">RGBA</span></code>,
the Alpha (A part of <code class="docutils literal notranslate"><span class="pre">RGBA</span></code>) is ignored unless the surface uses per pixel
alpha (Surface has the <code class="docutils literal notranslate"><span class="pre">SRCALPHA</span></code> flag).</p>
<div class="versionaddedold">
<p><span class="versionmodified added">New in pygame 1.8: </span>Optional <code class="docutils literal notranslate"><span class="pre">special_flags</span></code>: <code class="docutils literal notranslate"><span class="pre">BLEND_ADD</span></code>, <code class="docutils literal notranslate"><span class="pre">BLEND_SUB</span></code>,
<code class="docutils literal notranslate"><span class="pre">BLEND_MULT</span></code>, <code class="docutils literal notranslate"><span class="pre">BLEND_MIN</span></code>, <code class="docutils literal notranslate"><span class="pre">BLEND_MAX</span></code>.</p>
</div>
...
will be transparent. The color can be an <code class="docutils literal notranslate"><span class="pre">RGB</span></code> color, a string
(for <a class="reference internal" href="color_list.html"><span class="doc">Named Colors</span></a>), or a mapped color integer. If <code class="docutils literal notranslate"><span class="pre">None</span></code> is passed,
the colorkey will be unset.</p>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.3.1: </span>can now also accept both float coordinates and Vector2s for pixels.</p>
<p>Returning a Color instead of tuple. Use <code class="docutils literal notranslate"><span class="pre">tuple(surf.get_at((x,y)))</span></code>
...
<p>Set the color of a single pixel at the specified coordinates to be an <code class="docutils literal notranslate"><span class="pre">RGB</span></code>,
<code class="docutils literal notranslate"><span class="pre">RGBA</span></code>, string (for <a class="reference internal" href="color_list.html"><span class="doc">Named Colors</span></a>), or mapped integer color value. If the Surface
does not have per pixel alphas, the alpha value is ignored. Setting pixels outside the
Surface area or outside the Surface clipping will have no effect.</p>
<p>Getting and setting pixels one at a time is generally too slow to be used
...
<span class="sig-name descname"><span class="pre">get_frect</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Surface.get_frect" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">get the rectangular area of the Surface</span></div>
